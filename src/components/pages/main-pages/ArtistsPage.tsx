...
export function ArtistsPage() {
  ...
  return (
    <VirtualGrid items={artists} itemKey={(artist) => artist.name} label="艺术家，方向键浏览"
      renderItem={(artist) => {
        ...
        return (
          ...
          >
            ...
            <span className="block truncate font-serif text-sm font-bold text-ink" title={artist.name}>{artist.name}</span>
