  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <button
        ...
        title="上一首"
        aria-label="上一首"
        className="text-slate-500 hover:text-slate-800 transition-colors disabled:cursor-not-allowed disabled:opacity-35 disabled:hover:text-slate-500"
      >
      ...
      <button
        ...
        className={cn(
          "w-10 h-10 rounded-full bg-cyan-600 hover:bg-cyan-500 text-white flex items-center justify-center transform hover:scale-105 transition-all",
          "shadow-[0_4px_12px_rgba(8,145,178,0.25)]",
          isPlaying && "shadow-[0_4px_16px_rgba(8,145,178,0.45)]",
          !hasTrack && "cursor-not-allowed opacity-35 hover:scale-100 hover:bg-cyan-600"
        )}
      >
        {isPlaying ? (
      ...
      <button
        ...
        className={cn(
          ...
          !hasTrack && "cursor-not-allowed opacity-35 hover:text-slate-500"
        )}
      >
        <Heart
